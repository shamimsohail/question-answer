...
var favourite_fruit = ['apple', 'orange', 'grapes', 'bananas', 'watermelon'];
...
if ("".concat(favourite_fruit[1]) === 'orange') {
...
if ("".concat(favourite_fruit[3]) === 'kiwi') {
...
//ques 30
var users = ['saim', 'asad', 'ali', 'saad', 'admin'];
